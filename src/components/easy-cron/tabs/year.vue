  ...
  <div class="config-list">
    ...
    <div class="item">
      <el-radio label="TYPE_RANGE" class="choice" :disabled="disabled">区间</el-radio>
       从<el-input-number size="mini" :disabled="type!=TYPE_RANGE || disabled" :min="0" :precision="0"
        class="w60" v-model="valueRange.start" />年
       至<el-input-number size="mini" :disabled="type!=TYPE_RANGE || disabled" :min="1" :precision="0"
        class="w60" v-model="valueRange.end" />年
    </div>
    <div class="item">
      <el-radio label="TYPE_LOOP" class="choice" :disabled="disabled">循环</el-radio>
      从<el-input-number size="mini" :disabled="type!=TYPE_LOOP || disabled" :min="0" :precision="0"
       class="w60" v-model="valueLoop.start" />年开始，间隔
      <el-input-number size="mini" :disabled="type!=TYPE_LOOP || disabled" :min="1" :precision="0"
