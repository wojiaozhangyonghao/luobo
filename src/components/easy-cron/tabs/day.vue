  ...
  <div class="config-list">
    ...
    <div class="item">
      <el-radio label="TYPE_RANGE" class="choice" :disabled="disableChoice">区间</el-radio>
       从<el-input-number size="mini" :disabled="type!=TYPE_RANGE || disableChoice" :max="maxValue" :min="minValue" :precision="0"
        class="w60" v-model="valueRange.start" />日
       至<el-input-number size="mini" :disabled="type!=TYPE_RANGE || disableChoice" :max="maxValue" :min="minValue" :precision="0"
        class="w60" v-model="valueRange.end" />日
    </div>
    <div class="item">
      <el-radio label="TYPE_LOOP" class="choice" :disabled="disableChoice">循环</el-radio>
      从<el-input-number size="mini" :disabled="type!=TYPE_LOOP || disableChoice" :max="maxValue" :min="minValue" :precision="0"
    ...
    <div class="item">
      ...
      本月<el-input-number size="mini" :disabled="type!=TYPE_WORK || disableChoice" :max="maxValue" :min="minValue" :precision="0"
